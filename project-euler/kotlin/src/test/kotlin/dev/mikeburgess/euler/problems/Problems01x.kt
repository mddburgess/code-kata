...
class Problems01x {
    ...
    @Test
    fun `Problem 12`() {
        val result = triangleNumbers()
            .first { it.countDivisors() > 500 }

        assertThat(result).isEqualTo(76576500L)
    }
    ...
    fun `Problem 13`() {
        ...
        val result = numbers.map { BigInteger(it) }
            .reduce(BigInteger::add)
            .toString()
            .substring(0 until 10)
            .toLong()

        assertThat(result).isEqualTo(5537376230L)
    }
    ...
    @Test
    fun `Problem 14`() {
        val result = collatzLengthSequence()
            .take(999_999)
            .withIndex()
    ...
    @Test
    fun `Problem 19`() {
        val result = generateSequence(LocalDate.of(1901, 1, 1)) { it.plusMonths(1) }
            .takeWhile { it <= LocalDate.of(2000, 12, 31) }
            .count { it.dayOfWeek == DayOfWeek.SUNDAY }
            .toLong()

        assertThat(result).isEqualTo(171L)
    }
}
